...
# Amount of 20,000,000 satoshis to this address: 
...
RECIEPIENT_ADDRESS="2MvLcssW49n9atmksjwg2ZCMsEMsoj3pzUP"
CHANGE_ADDRESS=$(bitcoin-cli -regtest -rpcwallet=builderswallet getnewaddress)
...
AMOUNT=0.2
bitcoin-cli -regtest -named createpsbt inputs='''[{"txid":"'$TXID'","vout":'$VOUT_1'},{"txid":"'$TXID'","vout":'$VOUT_2'}]''' outputs='''[{"'$RECIEPIENT_ADDRESS'":"'$AMOUNT'"}]'''  
